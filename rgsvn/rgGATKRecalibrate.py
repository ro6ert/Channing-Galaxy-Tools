...
class GATKRecal():
    ...
    def writeImages(self,pdfs=[],res=[]):
        ...
        for i in range(npdfs): # these are all the posts - need to move, rename and make thumbnails
            ...
            spre = '<a href="%s"><img src="%s" alt="%s" hspace="10" align="middle"></a>' % (prefname,preimghref,prefname)
            spost = '<a href="%s"><img src="%s" alt="%s" hspace="10" align="middle"></a>' % (postfname,postimghref,postfname)
