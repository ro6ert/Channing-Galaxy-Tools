...
__FILE_ID__ = '$Id: pedfile.py,v 1.14 2009/07/13 20:16:50 rejpz Exp $'
...
class LPed:
    ...
    def parse(self):
        """
        """
        if VERBOSE: print 'pedfile: Analysis started: %s' % (timenow())
        self._map.parse()
        ...
        if VERBOSE: print 'pedfile: Analysis finished: %s' % (timenow())
